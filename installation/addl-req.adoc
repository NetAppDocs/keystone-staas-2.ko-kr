...
.소프트웨어 버전
. ONTAP 9.8 이상
. Active IQ Unified Manager(Unified Manager) 9.10 이후 버전 및 9.16P2 이전 버전
...
. Unified Manager 버전이 9.10 이상 9.16P2 이전인지 확인하십시오. Unified Manager 설치에 대한 자세한 내용은 다음 링크를 참조하십시오.
+
